...
tower.gun = {
    ...
    draw: function() {
      ...
      image(myTowerImg, this.pos.x, this.pos.y, this.radius * 2 * ts, this.radius * 2 * ts);
      pop();
    },
    ...
    //   // 使用你自己的图片绘制塔（图片将居中绘制在塔的位置）
    //   draw: function() {
    //     push();
    //     imageMode(CENTER);
    //     // 你可以根据需要调整图片的显示尺寸，这里用塔的半径乘上 ts 来确定尺寸
    //     image(myTowerImg, this.pos.x, this.pos.y, this.radius * 2 * ts, this.radius * 2 * ts);
    //     pop();
    //   },
  };
